...
export const dictionary: Record<Lang, Dictionary> = {
  cs: {
    ...
    membersTitle: "Členové", membersText: "Základní obsazení lze později rozšířit o další spolupracující interprety.",
  ...
  en: {
    ...
    membersTitle: "Members", membersText: "The basic line-up can later be extended with additional guest musicians.",
